...
void garage_parameter_init()
{
	...
	car.garage.out_garage_diff                = 100;
	car.garage.out_garage_distance            = 15;
	car.garage.out_garage_speed               = 150;
	/****方案1参数******/
	...
	car.garage.out_garage_curve_speed         = 250;
	/****方案2参数******/
	...
	/**************************入库*********************/
	/*****左入库参数*****/
	car.garage.enter_garage_distance_1_left   = 2;
	car.garage.enter_garage_angle_left        = 8;
	car.garage.enter_garage_distance_2_left   = 35;
	/*****左入库参数*****/
	...
	car.garage.distance_to_zebra              =  4000;
	car.garage.turn_point                     =  80;
	
	car.garage.forward_speed                  =  150;
	car.garage.forward_R                      =  15;
	car.garage.forward_distance               =  10;
	/**************************入库*********************/
}
/****************************************************
 * @name	       CitTie_judge
...
void CitTie_judge()
{
	...
	if(garage_flag == 0)
	{
		 if((P26==0)&&(car.garage.zebra_flag == 0))
		 {
			//暂时关闭磁铁检测
			garage_flag = 1;
			//记录磁铁位置
